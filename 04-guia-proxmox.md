...
# Si estás como root, consulta las VMs del usuario normal (ejemplo: usuario "luna")
...
# O si estás como root y la VM pertenece al usuario "luna"
...
> Esta parte se realiza una vez que el rack esté instalado en la sala A315.
