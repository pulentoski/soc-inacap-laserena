...
| **RAM** | 8192 MB (8 GB) |
| **Swap** | 2048 MB |
| **Network** | IP estática: IP_WAZUH/24, GW: IP_GATEWAY |
| **DNS** | 8.8.8.8 |
...
INFO: --- Summary ---
INFO: You can access the web interface https://IP_WAZUH
    User: admin
...
WAZUH_MANAGER='IP_WAZUH' dpkg-reconfigure wazuh-agent
...
| **CPU** | 2 núcleos |
| **RAM** | 2048 MB (2 GB) |
| **Network** | IP estática: IP_ZABBIX/24 |
...
1. Desde el navegador, ingresa a: `http://IP_ZABBIX/zabbix`
...
# (mismo proceso que A4, apuntando al Manager en IP_WAZUH)
WAZUH_MANAGER='IP_WAZUH' bash wazuh-agent-install.sh
```
...
|---|---|---|---|
| Proxmox Dell R720 | https://IP_PROXMOX_R720:8006 | root | (definida al instalar) |
| Wazuh Dashboard | https://IP_WAZUH | admin | (generada al instalar) |
| Zabbix Frontend | http://IP_ZABBIX/zabbix | Admin | zabbix (cambiar) |
| DVWA | http://IP_LAB:8080 | admin | password |
| Juice Shop | http://IP_LAB:3000 | - | - |
| WebGoat | http://IP_LAB:8888 | - | - |
